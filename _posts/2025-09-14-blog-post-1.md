...
level / frontier to the next frontier. The unit of work that Threads receive is a portion of the current BFS level being
...
idea is very simple to implement and scales well with more threads from small to large graphs.
