...
<div style="margin-bottom: 2rem;">
  <!-- Removed text-align: center; from the div -->
  <strong style="display: block; margin-left: -14px;">
    Table: LiveJournal Graph, Performance Comparison (16 physical, 32 virtual cores)
  </strong>

  <table style="border-collapse: collapse; font-size: 1.05rem; width: 50%; margin: 0 auto;">
    <thead>
      <tr>
        <th style="border: 1px solid #ccc; padding: 8px 14px;"></th>
        <th style="border: 1px solid #ccc; padding: 8px 14px;">1 thread</th>
        <th style="border: 1px solid #ccc; padding: 8px 14px;">32 threads</th>
      </tr>
    </thead>
    <tbody>
      <tr>
        <td style="border: 1px solid #ccc; padding: 8px 14px;">Shortest Path</td>
        <td style="border: 1px solid #ccc; padding: 8px 14px;">1890 ms</td>
        <td style="border: 1px solid #ccc; padding: 8px 14px;">274 ms (7x)</td>
      </tr>
      <tr>
        <td style="border: 1px solid #ccc; padding: 8px 14px;">Variable Length</td>
        <td style="border: 1px solid #ccc; padding: 8px 14px;">430 sec</td>
        <td style="border: 1px solid #ccc; padding: 8px 14px;">27 sec (16.5x)</td>
      </tr>
    </tbody>
  </table>
</div>
